...
<template>
  <aside class="w-64 bg-slate-900 text-white h-screen fixed left-0 top-0 flex flex-col z-50 overflow-hidden">

    <!-- Logo -->
    <div class="p-5 border-b border-slate-700/50 flex-shrink-0">
    ...
    <!-- Footer usuario — siempre visible abajo -->
