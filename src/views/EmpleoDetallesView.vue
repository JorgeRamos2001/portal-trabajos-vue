        ...
        <div class="lg:col-span-1">
          <div class="sticky top-20 space-y-4">
            ...
            <div class="bg-white border-2 border-slate-200 rounded-2xl p-6">
              ...
              <div class="bg-blue-50 border border-blue-200 text-blue-700 rounded-lg px-4 py-3 text-sm  gap-2">
                ℹ️ Debes <router-link to="/login" class="font-bold hover:underline">iniciar sesión</router-link> o <router-link to="/register" class="font-bold hover:underline">registrarte</router-link> para aplicar a este empleo.
              </div>
            </div>
